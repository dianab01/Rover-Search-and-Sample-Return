...
class RoverState():
    def __init__(self):
        ...
        self.rock_angles = None # Angles of the detected rock
        self.ground_truth = ground_truth_3d # Ground truth worldmap
        self.mode = 'forward' # Current mode (can be forward or stop)
        self.throttle_set = 0.2 # Throttle setting when accelerating
        self.brake_set = 10 # Brake setting when braking
        self.starting_position = None # Initial position of the rover on the map
        ...
        self.last_samples_collected = 0 # To check if a new sample has been collected since entering the "collect_rock" state
        self.near_sample = 0 # Will be set to telemetry value data["near_sample"]
        self.picking_up = 0 # Will be set to telemetry value data["picking_up"]
        self.send_pickup = False # Set to True to trigger rock pickup
        self.rock_in_fov = False
...
def telemetry(sid, data):
    ...
    if data:
        ...
        if not Rover.starting_position:
